...
## Verificación
- Ejecutar el build y una única pasada a 1280 px, modo claro, en Home, Demand System y Captación y cierre.
- Confirmar recuentos por altura, exclusiones correctas, visibilidad, FAQ cerradas y ausencia de desplazamiento horizontal.
