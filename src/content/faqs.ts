...
export const REVENUE_DIAGNOSTIC_FAQS: FaqItem[] = [
  ...
  { question: "¿Por qué RCKT necesita tanto acceso a mis datos?", answer: "Porque sin ellos no podemos medir hasta la venta. Los accesos son de lectura donde se puede y quedan documentados." },
...
export const DEMAND_SYSTEM_FAQS: FaqItem[] = [
  { question: "¿RCKT puede gestionar solo mis campañas?", answer: "Sí, si ya tienes CRM y proceso comercial funcionando. Si no, pagarías leads que se pierden después. Por eso empezamos con el Revenue Diagnostic: te dice con datos qué necesitas." },
  ...
  { question: "¿Qué necesita RCKT de mí para empezar?", answer: "Acceso de administrador a tus cuentas publicitarias, GTM y GA4, aprobación de creatividades en menos de 48 horas y acceso a los datos de ventas para cerrar el ciclo." },
...
export const SALES_FLOW_FAQS: FaqItem[] = [
  ...
  { question: "¿Qué necesita RCKT de mí?", answer: "Un número de WhatsApp Business API verificado, un CRM, un equipo comercial con un responsable nombrado, un acuerdo de SLAs internos y acceso a los datos de ventas." },
...
export const OPERATIONS_SYSTEM_FAQS: FaqItem[] = [
  { question: "¿RCKT hace chatbots con IA?", answer: "No vendemos chatbots. Si tu equipo repite un proceso muchas veces, lo medimos y lo automatizamos con supervisión humana." },
  ...
  { question: "¿RCKT depende de un proveedor de IA concreto?", answer: "No. Podemos cambiar el proveedor de IA sin rehacer el sistema: nuestro activo es el diseño del proceso, no la herramienta." },
  { question: "¿Qué necesita RCKT de mí?", answer: "Un dueño del proceso nombrado, acceso a los sistemas y datos, casos históricos para las pruebas y disponibilidad para validar durante el piloto." },
];
...
export const REVENUE_ENGINE_FAQS: FaqItem[] = [
  ...
  { question: "¿Por qué RCKT es más caro que otros?", answer: "Comparado con una agencia de medios, sí. Comparado con pagar campañas, web, CRM, chatbot y consultor por separado sin que nadie responda por el resultado, no. Y el Revenue Diagnostic te dice si el sistema se paga solo antes de comprometerte." },
  ...
  { question: "¿RCKT garantiza resultados?", answer: "No garantizamos ventas, porque no controlamos tu cierre, tu stock ni tus precios. Garantizamos que en 30 días verás tu embudo completo con datos reales y que cada decisión estará medida hasta la venta." },
];
...
export const CAPTACION_FAQS: FaqItem[] = [
  ...
  { question: "¿RCKT garantiza resultados?", answer: "No garantizamos ventas, porque no controlamos tu cierre, tu stock ni tus precios. Garantizamos que en 30 días verás tu embudo completo con datos reales." },
];
...
export const ECOMMERCE_RENTABLE_FAQS: FaqItem[] = [
  ...
  { question: "¿RCKT puede gestionar solo mis campañas?", answer: "Sí, si ya tienes CRM y proceso comercial funcionando. Si no, pagarías leads que se pierden después. Empezamos por el Revenue Diagnostic y te decimos con datos qué necesitas." },
...
export const OPERACION_FAQS: FaqItem[] = [
  { question: "¿RCKT hace chatbots con IA?", answer: "No vendemos chatbots. Si tu equipo repite un proceso muchas veces, lo medimos y lo automatizamos con supervisión humana." },
  { question: "¿Qué procesos se pueden automatizar?", answer: "Presupuestos desde WhatsApp o correo, clasificación y respuesta de solicitudes, generación y verificación de documentos, sincronización CRM ↔ ERP u hojas, reporting comercial y atención post-venta de primer nivel. Si tu proceso no está en esta lista, se evalúa antes de presupuestar." },
...
export const SALUD_FAQS: FaqItem[] = [
  ...
  { question: "¿Cómo se reduce el no-show?", answer: "Con recordatorios de cita y secuencias de seguimiento y recuperación dentro de Sales Flow." },
  ...
  { question: "¿Qué indicadores se miden?", answer: "Coste por paciente que compra y porcentaje de citas realizadas." },
];

export const SERVICIOS_B2B_FAQS: FaqItem[] = [
  { question: "¿RCKT trabaja con LinkedIn?", answer: "Sí. Usamos LinkedIn de forma selectiva para B2B, junto con Google Search, dentro de Demand System." },
  { question: "¿Cómo se miden los resultados?", answer: "Por coste por SQL y por la tasa de reunión a propuesta, no por coste por lead." },
